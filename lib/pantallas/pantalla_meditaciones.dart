...
class PantallaMeditaciones extends StatefulWidget {
  const PantallaMeditaciones({super.key});

  @override
  State<PantallaMeditaciones> createState() => _PantallaMeditacionesState();
}

class _PantallaMeditacionesState extends State<PantallaMeditaciones> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Pantalla Meditaciones'),),
    );
  }
}
